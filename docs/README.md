...
flowchart TD
  ...
  D1 -->|No| N1[No ticket CTA]

  D -->|Yes| E{Single-product free event?}

  E -->|No| P1{Sales active + not sold out?}
  ...
  T1 -->|No| T4["Delete unscanned free ticket(s) only<br>Decrement soldQuantity"]
