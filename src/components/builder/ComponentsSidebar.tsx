...
export const ComponentsSidebar = component$<ComponentsSidebarProps>((props) => {
  ...
  const contentBlocks = props.definitions.filter((d) => d.category === 'content');
  const dynamicBlocks = props.definitions.filter((d) => d.category === 'dynamic');
  ...
  return (
    <div class="w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div class="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        {filteredContentBlocks.length === 0 && filteredDynamicBlocks.length === 0 && (
