...
export const TileEditor = component$<TileEditorProps>((props) => {
	...
	return (
		<div class="space-y-3">
			<p class="block text-sm font-medium text-gray-700">Tiles</p>
							...
							<div class="border-t border-gray-200 px-3 py-3 space-y-3 bg-white">
								...
								{tile.type === "stat" && (
									<>
										<div>
											<label
												for={`tile-${index}-number`}
												class="block text-xs font-medium text-gray-600 mb-1"
											>
												Number
											</label>
											<input
												id={`tile-${index}-number`}
												type="text"
										...
										<div>
											<label
												for={`tile-${index}-description`}
												class="block text-xs font-medium text-gray-600 mb-1"
											>
												Description
											</label>
											<textarea
												id={`tile-${index}-description`}
												class="w-full text-sm border border-gray-300 rounded-md px-2 py-1.5 focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
												rows={2}
