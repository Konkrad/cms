  ...
  ({
    ...
    return (
      <div class="space-y-4">
        ...
        {helpText && <p class="text-sm text-text-muted mt-1">{helpText}</p>}
        ...
        <div class="bg-bg-muted rounded-lg p-4">
          <div class="text-sm font-medium text-text mb-2">Start</div>
          <input
            ref={startInputRef}
            type="text"
        ...
        {isMultiDay.value && (
          <div class="bg-bg-muted rounded-lg p-4">
            <div class="text-sm font-medium text-text mb-2">End</div>
            <input
              ref={endInputRef}
              type="text"
