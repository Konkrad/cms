...
export const useEvent = routeLoader$(async (event) => {
  ...
  if (!eventData) {
    // Redirect back to the events list for the current admin context (global or group)
...
export default component$(() => {
  ...
  // Compute the current admin context (global or group) so links can be context-aware
