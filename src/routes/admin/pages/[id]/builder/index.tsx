...
export default component$(() => {
  ...
  const handleUpdateBlockData = $((blockId: string, newData: Record<string, any>) => {
    ...
    <div class="fixed inset-0 bg-gray-50 flex flex-col">
      <div class="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
        <div class="flex items-center gap-4">
          ...
          <h1 class="text-lg font-semibold text-gray-900">{page.value.title}</h1>
      ...
      <div class="flex-1 flex overflow-hidden">
        ...
        <PropertiesPanel
          selectedBlock={blocks.value.find((b) => b.id === selectedBlockId.value)}
          definition={
            selectedBlockId.value
              ? definitionsMap.value.get(
                  blocks.value.find((b) => b.id === selectedBlockId.value)?.componentType || ''
                )
              : undefined
          }
