  ...
  return (
    <div class="max-w-3xl mx-auto px-4 py-8">
      ...
      {data.value.groups.length === 0 ? (
        ...
        <div class="space-y-6">
          {data.value.groups.map(({ cycle, apps }) => (
                  ...
                  <li key={app.id} class="px-5 py-4">
                    <div class="flex items-start justify-between">
                      <div>
                        ...
                        <div class="text-xs text-gray-400 mt-0.5">Applied {app.createdAt.slice(0, 10)}</div>
                      </div>
                    ...
                    {app.status === "rejected" && app.adminNote && (
                      <div class="mt-2 text-sm text-gray-600 bg-red-50 border border-red-100 rounded px-3 py-2">
                        <span class="font-medium">Feedback: </span>{app.adminNote}
                      </div>
                    )}
                  </li>
                ))}
