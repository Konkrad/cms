...
export default component$<PurchaseListProps>(
	({ transactions, buyerUserId, updateParticipantsAction, qrBust }) => {
		...
		const renderTicket = (ticket: TicketWithRelations, isUpcoming: boolean) => {
				...
				>
					<div class="flex items-center justify-between gap-3 px-3 py-2.5">
						<div class="min-w-0">
							...
							{p0 && (
								<span
									class={`inline-flex items-center gap-1 mt-0.5 text-xs ${isAssignedAway ? "text-warning" : "text-text-muted"}`}
								>
